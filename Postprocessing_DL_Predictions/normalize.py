...
for file in os.listdir():
    #"HumanDerived" in file or "ChimpDerived" in file or 
    if ("Polymorphic" in file or "HumanDerived" in file or "ChimpDerived" in file and 'Chpreffed' not in file) and "All_DL" not in file and "fixed" in file:
        print(file)
