...
if new_ct == "Purkinje":
    ...
    assert(False)
o = open("/scratch/users/astarr97/TempSortedDL/All_DL_" + new_ct + "_Polymorphic_Normed_Temp" + str(to_do) + ".ready.txt")

if to_do == 1:
    out = open("Taus_Polymorphic_Group1_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out.write("Position\tTau_Allele1\tTau_Allele2\tTau_abs_logfc\tTau_jsd\n")
    out2 = open("KosoyRoussosControlMicroglia_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out2.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out3 = open(act_ct + "_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out3.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out4 = open("AdultHeartVentricularCardiomyocyte_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out4.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out5 = open("AdultProximalTubule_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out5.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out6 = open("FetalArterialECs_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out6.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out7 = open("FetalChondrocytes_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out7.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out8 = open("SertoliMale_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out8.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out9 = open("ASCT_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out9.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
elif to_do == 2:
    out = open("Taus_Polymorphic_Group2_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out.write("Position\tTau_Allele1\tTau_Allele2\tTau_abs_logfc\tTau_jsd\n")
    out2 = open("FetalGonadImmuneFemale_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out2.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out3 = open(act_ct + "_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out3.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out4 = open("AdultHeartSmoothMuscle_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out4.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out5 = open("AdultLoopOfHenle_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out5.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out6 = open("FetalHeartPericytes_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out6.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out7 = open("FetalHeartCardiacFibroblasts_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out7.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out8 = open("preGC_IIaFemale_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out8.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
    out9 = open("FetalBrainCOP_EEs_Polymorphic_WithNeuron" + "_" + new_ct + str(to_do) + ".txt", 'w')
    out9.write("Position\tEE_Allele1\tEE_Allele2\tdEE_logfc\tEE_jsd\tEE_abs_logfc\n")
