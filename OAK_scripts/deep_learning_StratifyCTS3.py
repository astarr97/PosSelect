...
out = open("StratifyCTS_New/" + dl_prefix + "/StratifyCTS_FilterNewTEs_RemTopTwoCT_" + cts_metric + "_" + "Group" + str(group) + "_" + "SpecSup" + str(spec_sup) + "_" + dl_prefix + ".txt", 'w')
...
if tau:
    cts_metric = "Tau"
    if group == 1:
        cts_fixed = pd.read_csv(dl_path + "Taus_HumanDerived_Group1_NoLiangSteinNeuron_NoMicroglia.txt", sep = "\t").set_index("Position")
        cts_poly = pd.read_csv(dl_path + "Taus_Polymorphic_Group1_NoLiangSteinNeuron_NoMicroglia.txt", sep = "\t").set_index("Position")
    elif group == 2:
        cts_fixed = pd.read_csv(dl_path + "Taus_HumanDerived_Group2_NopreGC_IIa_NoITL23.txt", sep = "\t").set_index("Position")
        cts_poly = pd.read_csv(dl_path + "Taus_Polymorphic_Group2_NopreGC_IIa_NoITL23.txt", sep = "\t").set_index("Position")
